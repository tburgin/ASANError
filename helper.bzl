...
def santa_unit_test(
    ...
    macos_unit_test(
        ...
        size = size,
        data = data,
	    env = {"DYLD_INSERT_LIBRARIES": "/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/13.0.0/lib/darwin/libclang_rt.asan_osx_dynamic.dylib"},
